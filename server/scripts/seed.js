...
const demoUser = await User.findOneAndUpdate(
  { email: 'demo@onetapz.link' },
  {
    ...
    email: 'demo@onetapz.link',
    username: 'zara',
    bio: 'CamTech student · UI/UX designer & content creator. Tap in for my work, socials, and contact.',
    profileImage:
...
await Link.insertMany([
  ...
  },
  {
    userId: demoUser._id,
    title: 'Instagram',
    url: 'https://instagram.com/onetapz',
    icon: 'instagram',
    order: 1,
    clickCount: 31,
  },
  ...
  },
  {
    userId: demoUser._id,
    title: 'LinkedIn',
    url: 'https://linkedin.com/in/onetapz',
    icon: 'linkedin',
    order: 3,
    clickCount: 14,
  },
