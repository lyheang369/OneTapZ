// URL safety filter for user-submitted links. Blocks dangerous schemes and
// links pointing at adult / prohibited sites. This is a pragmatic blocklist —
// for full malware/illegal coverage, layer a Safe Browsing API on top.

const ALLOWED_SCHEMES = ['http:', 'https:', 'mailto:', 'tel:'];

// Strong adult-content tokens that appear in a hostname (low false-positive
// risk — note we deliberately omit weak tokens like "sex" that collide with
// place names such as "middlesex").
...
// Known adult / prohibited domains (matched on exact host or subdomain).
